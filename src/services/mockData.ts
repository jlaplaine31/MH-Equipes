...
const participants: Participant[] = [
  ...
  { id: 'p2', sessionId: 'demo-1', name: 'Julien M.', service: 'Reporting & Performance', scoreCopilot: 0, scoreMia: 4, sessionToken: 'tok_p2', teamId: null, createdAt: '2026-03-23T10:06:00Z' },
  ...
  { id: 'p4', sessionId: 'demo-1', name: 'Thomas R.', service: 'Hypervision & Planification', scoreCopilot: 1, scoreMia: 0, sessionToken: 'tok_p4', teamId: null, createdAt: '2026-03-23T10:08:00Z' },
  { id: 'p5', sessionId: 'demo-1', name: 'Camille B.', service: 'Transformation', scoreCopilot: 0, scoreMia: 2, sessionToken: 'tok_p5', teamId: null, createdAt: '2026-03-23T10:09:00Z' },
  ...
  { id: 'p7', sessionId: 'demo-1', name: 'Léa V.', service: 'Conformité', scoreCopilot: 2, scoreMia: 0, sessionToken: 'tok_p7', teamId: null, createdAt: '2026-03-23T10:11:00Z' },
  { id: 'p8', sessionId: 'demo-1', name: 'Nathan G.', service: 'Hypervision & Planification', scoreCopilot: 0, scoreMia: 5, sessionToken: 'tok_p8', teamId: null, createdAt: '2026-03-23T10:12:00Z' },
